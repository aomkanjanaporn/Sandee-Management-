...
<div class="row mt">
   <div class="col-sm-12">
	<div class="container">
        <section class="panel">
        <h2> แก้ไขข้อมูลเจ้าของโครงการ</h2>
            <div class="panel-body minimal">
				<input type="hidden" name="id" value="<?echo $rowsd['user_id'];?>">
					<ul class="nav nav-pills nav-stacked " >
						...
						<form action="profile_owner.php" method="POST" enctype="multipart/form-data" >
							...
							<li class="active row">
								<div class="form-group col-lg-6" style="padding-right: 20px;padding-left: 20px;">
									...
									<div class="col-lg-6">
										<input type="file" name="owner_img" class="form-control" required> 
									</div>
									<div class="col-lg-3">
					...
					<form action="save_owner.php" method="POST" >
						  ...
						  <li class="active  row">
							...
							<div class="col-lg-8">
								<input type="text" type="email" class="form-control" value="<?echo $rowsd['user_email'];?>" required="">
							</div>
						  </div>
						  </li>
						  <li class="active  row">
