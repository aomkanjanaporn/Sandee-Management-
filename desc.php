					 ...
					 <!-- /ใส่วันซ่อมและช่างที่เข้าไปจาก admin -->
						...
						<div class="col-md-4">
							...
							<div>
								...
								<form action="save_repairc.php" method="POST">
									...
									<div>
										  <div class="pull-left">
										    <input type="radio" style="width: 20px" id="" value="1" name="comfirm_repair"  checked /> ว่าง
											<input type="radio" style="width: 20px" id="" value="2" name="comfirm_repair" />ไม่ว่าง
										  </div>
									...
									<br>
									<div>
										  <div class="pull-left">สะดวกวันที่  :</div>
										  <div class="pull-right">
										  <?
										$date=str_replace(" ","T",$rows['date_repair']);
										  ?>
										  <input type="datetime-local" value="<?echo  $date;?>" class="form-control" name="date">
										  </div>
										  <div class="clearfix"></div>
									</div>
									<!-- /row -->
