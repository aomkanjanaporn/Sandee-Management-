...
<div class="row mt">
    <div class="col-sm-4">
        <section class="panel">
			...
			<h3><b> จัดการรายชื่อผู้ดูแลระบบ  </b></h3>
			
			<form action="add_admin.php" method="POST" enctype="multipart/form-data" id="manage-employee-profile" class="form-horizontal tasi-form">
				<ul class="nav nav-pills nav-stacked mail-nav">
					<li class="active  ">
						<div class="form-group " style="padding-right: 20px;padding-left: 20px;">
							...
							<div class="col-lg-8">
								<input type="file" name="admin_img" accept="image/*" class="form-control" required />
							</div>
						</div>
					</li>
					<li class="active ">
					...
					<li class="active ">
						  ...
						  <div class="form-group" style="padding-right: 20px;padding-left: 20px;">
							...
							<div class="col-lg-8">
								<input type="text" onKeyUp="return noNumbers(event)" id="phone_no" name="phone_no" class="form-control"  required>
							</div>
						  </div>
						  </li>
				<hr>
						...
						<div class="form-group " style="padding-right: 20px;padding-left: 20px;">
							<div class="col-lg-12">
								<div class="col-md-6 col-md-offset-6 row-12">
									...
									<button type="reset" onclick="create_admin('0');" class="btn btn-theme02"><i class="fa fa-minus"></i> &nbsp;ยกเลิก</button>
								</div>
							</div>
						</div>
					</li>
						...
						<tbody>
							...
							while($rows=mysql_fetch_assoc($result)){
								...
								<tr>
									...
									<td class="cpt" onclick="edit_useradmin('<?echo $rows['user_id'];?>');" >
